...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        # Handle the case where the user is not an admin, teacher, or student
        return render(request, 'school/access_denied.html')  # Create this template for access denied
